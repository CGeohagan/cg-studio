...
//        'title' => __( 'Site Options', 'cg-studio' ),
...
//function cg_studio_mce_buttons_2($buttons) {	
//	/**
...
//	return $buttons;
//}
//add_filter('mce_buttons_2', 'cg_studio_mce_buttons_2');


// Remove all colors except those custom colors specified from TinyMCE
//function cg_studio_change_mce_options( $init ) {
//	$custom_colors = '"#####1", "Color Name 1", "#####2", "Color Name 2", "#####3", "Color Name 3"';	
//	$init['textcolor_map'] = '['.$custom_colors.']';
//return $init;
//}
//add_filter('tiny_mce_before_init', 'cg_studio_change_mce_options');


// Modify the query on a given template (using conditionals)
//function cg_studio_custom_query($query) {
//    if ($query->is_search) {
//        $query->set('post_type', 'post');
//    }
//    return $query;
//}
//add_filter('pre_get_posts','cg_studio_custom_query');
?>